...
# Top 10 bar chart code already defined in your file, so reuse it here.
```
...
```{r fig-norway-trend, echo=FALSE, message=FALSE, warning=FALSE}
# Norway trend line chart code (already present in your .qmd)
```
...
```{r fig-norway-sources, echo=FALSE, message=FALSE, warning=FALSE}
# You already have this pie/bar chart in your code
```
