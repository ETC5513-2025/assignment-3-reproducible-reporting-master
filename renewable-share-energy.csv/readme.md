...
This data package contains the data that powers the chart ["Share of primary energy consumption from renewable sources"](https://ourworldindata.org/grapher/renewable-share-energy?tab=table&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 17, 2025.
